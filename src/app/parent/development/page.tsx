...
import { Target, ShieldCheck, Calendar, CheckCircle2 } from "lucide-react";
...
export default function ParentDevelopmentPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Holistic Growth & Character Development"
        subtitle="Continuous developmental milestones across 8 core dimensions evaluated by educators"
      />
          ...
          return (
            <div key={r.id} className="card" style={{ padding: "22px", display: "flex", flexDirection: "column" }}>
              ...
              >
                ...
                >
                  <ShieldCheck size={14} /> Official School Record
                </span>
              </div>
            </div>
          );
