...
export default function StudentActivitiesPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Co-Curriculars & Clubs"
        subtitle="School clubs, robotics competitions, community projects, and team sports"
      />

      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(340px, 1fr))", gap: "20px" }}>
        {activities.map((act) => (
          <div key={act.id} className="card" style={{ padding: "22px", display: "flex", flexDirection: "column" }}>
            ...
            {act.reflection && (
              <div style={{ background: "#f8fafc", padding: "10px", borderRadius: "6px", fontSize: "12px", color: "#475569" }}>
                <strong>Teacher Remark:</strong> {act.reflection}
              </div>
            )}
          </div>
        ))}
